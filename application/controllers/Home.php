...
class Home extends AUTH_Controller {
	...
	public function index() {
		...
		$data['jml_nasabah'] 	= $this->M_nasabah->total_rows();
		// $data['jml_pengajuan'] 	= $this->M_nasabah->total_pengajuan();
		$data['jml_posisi'] 	= $this->M_posisi->total_rows();
		$data['jml_kota'] 		= $this->M_kota->total_rows();
		$data['userdata'] 		= $this->userdata;

		$data['total_pengajuan_bulan'] = $this->M_nasabah->select_jumlah_pengajuan();
		$data['total_pencairan_bulan'] = $this->M_nasabah->select_jumlah_pencairan();
